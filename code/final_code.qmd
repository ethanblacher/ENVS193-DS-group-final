...
table
```
>>>>>>> e321bcaca55d48582637574ae7ea4337960baaba
...
flowermod2.a <- glm(nr_seeds~treatment+species+total_nr_infl, data = flower, family="poisson")
...
flowermod3.a <- glmmTMB(nr_seeds~treatment+species+total_nr_infl, data = flower, family = "nbinom2")

# generalized linear model with Poisson distribution and random effect of site
flowermod4 <- glmer(nr_seeds~treatment+species+total_nr_infl + (1|site), data = flower, family = "poisson")

flowermod4.a <- glmmTMB(nr_seeds~treatment+species+total_nr_infl + (1|site), data = flower, family = "poisson")

# generalized linear model with negative binomial distribution and random effect of site
flowermod5 <- glmer.nb(nr_seeds~treatment+species+total_nr_infl + (1|site), data = flowermod)

flowermod5.a <- glmmTMB(nr_seeds~treatment+species+total_nr_infl + (1|site), data = flower, family = "nbinom2")
```
